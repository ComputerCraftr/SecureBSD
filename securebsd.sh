...
collect_user_input() {
  ...
  echo "Enter the external network interface for IPFW (and Suricata, if installed), or type 'none' if not applicable (default: none)."
  ...
  echo "Enter the VPN tunnel network interface for IPFW, or type 'none' if not using a VPN (default: none)."
  ...
  echo "Enter the internal network interface for IPFW, or type 'none' if not using a bridge/gateway (default: none)."
